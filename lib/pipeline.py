...
def pipeline(df, total_df, levels, level, agora2_level_set, agora2_species, agora2_genera):
    ...
    associated_species_agora2 = species_genus_association.association(total_df_species_in_agora, levels, level)
    associated_genus_agora2 = species_genus_association.association(total_df_genera_in_agora, levels, level)
