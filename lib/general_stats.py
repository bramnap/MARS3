...
def general_stats(initial_df, list_phylum_df, list_species_genus_dfs, extra_phyla=None):
    ...
    reads_df, norm_df, norm_cut_df, renorm_df = list_species_genus_dfs
    ...
    before_agora_taxa = reads_df[reads_df > 0].count()
    ...
    after_agora_taxa = norm_df[norm_df > 0].count()
    ...
    loss_to_cutoff = sum_rename_sort(norm_df, 'Sum of rel. abund. 1st norm')
